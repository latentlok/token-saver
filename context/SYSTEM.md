...
| doc | for |
|---|---|
| `docs/archive/a92e876/PRINCIPLES.md` | **the short version.** The structural rules everything else is a corollary of. Read first if you want the reasoning rather than the details. |
