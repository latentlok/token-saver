...
from . import challenge, contract, red
...
GateRun = namedtuple("GateRun", "objection gate_output expect contract_path contract_tests work_cwd")
...
GateRun.__new__.__defaults__ = (None, None, None, None, None, None)
